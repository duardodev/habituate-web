...
export function Buttons() {
  ...
  return (
    <div className="mt-2 flex flex-wrap justify-center items-center gap-4">
      <Button className="h-9 border-none" asChild>
      ...
      <Button
        variant="outline"
        asChild
        className="h-9 bg-secondary-foreground/95 text-background hover:text-background hover:bg-secondary-foreground/85"
      >
