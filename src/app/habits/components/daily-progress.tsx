...
export function DailyProgress() {
  return (
    <div className="relative h-full min-[375px]:h-[250px] w-[320px] rounded-3xl p-4 bg-white dark:bg-background border border-zinc-200 dark:border-zinc-800 transition-all duration-300 shadow-lg">
